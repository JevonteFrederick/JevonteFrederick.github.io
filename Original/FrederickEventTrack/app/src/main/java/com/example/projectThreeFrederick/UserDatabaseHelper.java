...
public class UserDatabaseHelper extends SQLiteOpenHelper {
    ...
    public ArrayList<event> getAllEvents(@NonNull ArrayList<event> events){
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                events.add(new event(ide, name, date, notes));
    ...
    public long addEvent(String name, String date, String notes){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
    ...
    public long updateEvent(Long eventID, String name, String date, String notes){
        SQLiteDatabase db = this.getReadableDatabase();
        ContentValues values = new ContentValues();
