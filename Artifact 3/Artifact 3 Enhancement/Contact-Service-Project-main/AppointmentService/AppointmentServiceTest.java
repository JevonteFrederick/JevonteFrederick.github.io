...
class AppointmentServiceTest {
	...
	void testAppointmentServiceAddException() {
		AppointmentService service = new AppointmentService();
		Date appointmentDate = new Date(System.currentTimeMillis() + 1);
		Appointment talk = new Appointment("1234567855", appointmentDate, "Appointment for a discussion.");
		
		appointmentDate = new Date(System.currentTimeMillis() + 99999999);
		Appointment followUp = new Appointment("1234567855", appointmentDate, "Appointment for Follow-up.");
	...
	void testAppointmentServiceDelete() {
		AppointmentService service = new AppointmentService();
		Date appointmentDate = new Date(System.currentTimeMillis() + 1);
		Appointment talk = new Appointment("1234567790", appointmentDate, "Appointment for a discussion.");
		
		appointmentDate = new Date(System.currentTimeMillis() + 99999999);
		Appointment followUp = new Appointment("1234567791", appointmentDate, "Appointment for Follow-up.");
		
		service.addAppointment(talk);
		service.addAppointment(followUp);
		
		service.deleteAppointment("1234567790");
	}
	...
	void testAppointmentServiceDeleteException() {
		AppointmentService service = new AppointmentService();
		Date appointmentDate = new Date(System.currentTimeMillis() + 1);
		Appointment talk = new Appointment("1234563890", appointmentDate, "Appointment for a discussion.");
		
		appointmentDate = new Date(System.currentTimeMillis() + 99999999);
		Appointment followUp = new Appointment("1234563891", appointmentDate, "Appointment for Follow-up.");
